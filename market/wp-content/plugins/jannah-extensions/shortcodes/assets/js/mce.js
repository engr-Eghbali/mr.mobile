			...
			// [padding] Shortcodes ----------
			{
				...
				onclick: function() {
					editor.windowManager.open( {
						...
						body: [
							{
								type: 'textbox',
								name: 'top',
								label: jannah_extensions_lang.shortcode_padding_top,
								value: '0',
							},
							{
								type: 'textbox',
								name: 'bottom',
								label: jannah_extensions_lang.shortcode_padding_bottom,
								value: '0',
							},
							{
								type: 'textbox',
						...
						onsubmit: function( e ) {
							editor.insertContent( '[padding top="'+ e.data.top+ '" bottom="'+ e.data.bottom+ '" right="'+ e.data.right+ '" left="'+ e.data.left+ '"]' + editor.selection.getContent() + '[/padding]' );
						}
					});
				}
			},
