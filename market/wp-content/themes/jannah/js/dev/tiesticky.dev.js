/*!
 * tiesticky.js v1.0.0 Sticky Navigation Menu with Defautl stikcy and when scrolling upwards behaviors.
...
(function(root, factory) {
  ...
  function TieSticky (elem, options) {
    ...
    this.offset           = ($body.hasClass('admin-bar'))? this.offset - 32 : this.offset;
  ...
  TieSticky.prototype = {
    ...
    init : function() {
      ...
      if(this.behaviorMode == 'default'){
        this.elem.classList.add('defautl-behavior-mode');
      }
