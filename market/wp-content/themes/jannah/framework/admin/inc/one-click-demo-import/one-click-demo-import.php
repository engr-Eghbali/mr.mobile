...
class PT_One_Click_Demo_Import {
	...
	<div id="tie-import-wrap" class="ocdi wrap about-wrap tie-about-wrap">
		...
		if ( ini_get( 'safe_mode' ) ){
			printf(
				esc_html__( '%sWarning: your server is using %sPHP safe mode%s. This means that you might experience server timeout errors.%s', 'jannah' ),
...
<?php // by TieLabs ***************************************************************?>
		...
		<?php
			...
			if( get_option( JANNAH_THEME_FOLDER .'_history' ) ){
				...
				?>
				<a id="tie-uninstall-demo" class="tie-primary-button button button-primary button-large tie-button-red" href="<?php echo esc_url( $uninstall_url ); ?>"><?php echo esc_html__( 'Uninstall the Demo Data', 'jannah' ); ?></a>
				<?php
			}
		?>
				...
				<div class="theme-wrap wp-clearfix">
					...
					<div class="theme-about wp-clearfix">
						...
						<div class="theme-info">
							...
							<h3 class="theme-name">15zine | Shared By themes24x7.com</h3>
							<p class="theme-tags"></p>

							<div id="theme-description" class="theme-description">Responsive, modern and clean Wordpress Theme</div>
