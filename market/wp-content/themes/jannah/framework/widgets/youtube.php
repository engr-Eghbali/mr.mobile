	 ...
	 */
	 class TIE_YOUTUBE_WIDGET extends WP_Widget {
		...
		public function __construct(){
			parent::__construct( 'youtube-widget', JANNAH_THEME_NAME .' - '.esc_html__( 'YouTube', 'jannah' ) );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' =>esc_html__( 'Subscribe to our channel', 'jannah') );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'page_url' ) ) ?>"><?php esc_html_e( 'Channel Name or ID:', 'jannah') ?></label>
				...
				<small><a href="<?php echo esc_url( 'https://www.youtube.com/account_advanced' ); ?>" target="_blank"><?php esc_html_e( 'Get it from your account advanced page.', 'jannah') ?></a></small>
			</p>
